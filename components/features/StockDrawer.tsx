...
export function StockDrawer({
  ...
  return (
    ...
    >
      ...
      />
      <aside
        className={`absolute right-0 top-0 flex h-full w-full max-w-[1100px] flex-col overflow-hidden border-l border-[#23252a] bg-[#010102] p-6 text-[#f7f8f8] shadow-[-24px_0_80px_rgba(0,0,0,0.45)] transition-transform duration-[180ms] ease-out ${isOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        ...
        <div className="mt-6 flex min-h-0 flex-1 gap-6">
          <div className="min-h-0 min-w-0 flex-[6] overflow-y-auto pr-1">
